...
const { getAllResumes, getResume, createResume, updateResume, deleteResume, clearResume, downloadResume, downloadResumeFromHtml } = require('../controllers/resume.controller')
