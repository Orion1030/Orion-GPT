...
const { getTemplates, getTemplate, createTemplate, updateTemplate, deleteTemplate, clearTemplates, seedTemplates, migrateBuiltInTemplates, generateTemplateWithAi } = require('../controllers/template.controller')
...
router.route('/ai-generate').post(isAuthenticatedUser, permit([RoleLevels.ADMIN]), accessGuard, generateTemplateWithAi)
