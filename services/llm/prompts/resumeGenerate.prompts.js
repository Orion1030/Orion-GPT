function buildResumeGenerationSystemPrompt() {
  return [
    ...
    "- Profile career history key points are also factual candidate evidence and may be used for personal achievements when consistent with role/company/date.",
    "- Profile career history is also context guidance for company strategy, business challenges, platform direction, domain constraints, and period-appropriate framing.",
